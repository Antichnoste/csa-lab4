...
4. `prob1.lisp` — рекурсивное решение Euler 4, математика, стек и возвраты.
5. `sort.lisp` — сортировка строки как массива ASCII-символов.
6. `tail_recursion.lisp` — хвостовая рекурсия и работа стека.
