...
> **Статус:** Лабораторная работа защищена на **40 баллов**
>
> Все вспомогательные материалы (шпаргалки), подготовленные в ходе работы над проектом, теперь открыты и доступны в этом репозитории.
